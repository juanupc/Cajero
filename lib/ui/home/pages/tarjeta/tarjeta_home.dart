...
import 'package:calculator_app/ui/home/pages/tarjeta/pages/retiro.dart';
import 'package:flutter/material.dart';
import 'package:google_fonts/google_fonts.dart';
import 'package:remixicon/remixicon.dart';

class AmountSelectionTarjetaPage extends StatefulWidget {
  final Usuario usuarioActual;

  const AmountSelectionTarjetaPage({super.key, required this.usuarioActual});

  @override
  _AmountSelectionTarjetaPageState createState() => _AmountSelectionTarjetaPageState();
}

class _AmountSelectionTarjetaPageState extends State<AmountSelectionTarjetaPage> {
  final TextEditingController _customAmountController = TextEditingController();
  final List<int> _predefinedAmounts = [10000, 20000, 50000, 100000];

  void _navigateToTarjetaPage(int amount, Usuario usuarioActual) {
    if (amount > 9999 && amount % 10000 == 0 && amount <= 1800000) {
      Navigator.push(
        context,
        MaterialPageRoute(
          builder: (context) => TarjetaPage(monto: amount, usuarioActual: usuarioActual),
        ),
      );
    } else {
      _showErrorDialog();
        ...
        child: Column(
          children: [
            ..._predefinedAmounts.map((amount) => ListTile(
                  ...
                  onTap: () => _navigateToTarjetaPage(amount, widget.usuarioActual),
                )),
            ...
            Container(
              ...
              child: TextButton(
                ...
                onPressed: () {
                  ...
                  _navigateToTarjetaPage(customAmount, widget.usuarioActual);
                },
                child: Text(
                  'Retirar',
                  style: GoogleFonts.saira(
