...
class AhorroPage extends StatefulWidget {
  ...
  const AhorroPage({super.key, required this.monto, required this.usuarioActual});

  @override
  _AhorroPageState createState() => _AhorroPageState();
}
...
class _AhorroPageState extends State<AhorroPage> {
  ...
  void _generateDynamicCode() {
    setState(() {
      codigo = (Random().nextInt(900000) + 100000).toString();
    });
  }
        ...
        builder: (context) => AlertDialog(
          ...
          content: Column(
            ...
            children: [
              ...
              Text(
                'Celular: 0${widget.usuarioActual.numeroTelefono}',
                style: GoogleFonts.saira(
                  fontSize: 17,
                  color: Colors.black,
                ),
              ...
              Text(
                'Tipo de Transacción: Retiro Ahorro a la Mano',
                style: GoogleFonts.saira(
                  fontSize: 17,
                  color: Colors.black,
                ),
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              Text(
                'Teléfono: 0${widget.usuarioActual.numeroTelefono}',
                style: GoogleFonts.saira(
                  fontSize: 17,
                  color: Colors.black
                ),
