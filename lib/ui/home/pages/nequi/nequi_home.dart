...
import 'package:calculator_app/ui/home/pages/nequi/pages/retiro.dart';
import 'package:flutter/material.dart';
import 'package:google_fonts/google_fonts.dart';
import 'package:remixicon/remixicon.dart';

class AmountSelectionNequiPage extends StatefulWidget {
  final Usuario usuarioActual;

  const AmountSelectionNequiPage({super.key, required this.usuarioActual});

  @override
  _AmountSelectionNequiPageState createState() => _AmountSelectionNequiPageState();
}

class _AmountSelectionNequiPageState extends State<AmountSelectionNequiPage> {
  final TextEditingController _customAmountController = TextEditingController();
  final List<int> _predefinedAmounts = [10000, 20000, 50000, 100000];

  void _navigateToNequiPage(int amount, Usuario usuarioActual) {
    if (amount > 9999 && amount % 10000 == 0 && amount <= 1800000) {
      Navigator.push(
        context,
        MaterialPageRoute(
          builder: (context) => NequiPage(monto: amount, usuarioActual: usuarioActual),
        ),
      );
    } else {
      _showErrorDialog();
        ...
        child: Column(
          children: [
            ..._predefinedAmounts.map((amount) => ListTile(
                  ...
                  onTap: () => _navigateToNequiPage(amount, widget.usuarioActual),
                )),
            ...
            Container(
              ...
              child: TextButton(
                ...
                onPressed: () {
                  ...
                  _navigateToNequiPage(customAmount, widget.usuarioActual);
                },
                child: Text(
                  'Retirar',
                  style: GoogleFonts.saira(
